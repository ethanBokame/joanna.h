...
void color1(char clr[], char clr_select[])
{
...
// FONCTION SERVANT A ECRIRE LES ENTIERS ET LES FLOATS EN COULEUR

void color2(float var, char clr_select[])
{
    if (clr_select == "orange")
    {
        printf("\033[38;5;208m%g\033[0m",var);  // Code ANSI de l'orange
    }
    if (clr_select == "red")
    {
        printf("\033[31m%g\033[0m",var);  // Code ANSI du rouge
    }
    if (clr_select == "blue")
    {
        printf("\033[34m%g\033[0m",var);  // Code ANSI du bleu
    }
    if (clr_select == "green")
    {
        printf("\033[32m%g\033[0m",var);  // Code ANSI du vert
    }
    if (clr_select == "yellow")
    {
        printf("\033[33m%g\033[0m",var);  // Code ANSI du jaune
    }
    if (clr_select == "magenta")
    {
        printf("\033[35m%g\033[0m",var);  // Code ANSI du magenta
    }
    if (clr_select == "cyan")
    {
        printf("\033[36m%g\033[0m",var);  // Code ANSI du cyan
    }
}
...
// FONCTION SERVANT A SOULIGNER LES ENTIERS ET LES FLOATS

void underline2(float var)
{
    printf("\033[4m%g\033[0m",var);  // Séquence d'échappement ANSI pour souligner
}
...
// FONCTION SERVANT A METTRE EN GRAS LES CARACTERES ET LES CHAINES DE CARACTERES

void bold1(char clr[], char clr_select[])
{
    if (clr_select == "white")
    {
        printf("\033[1m%s\033[0m",clr);
    }
    
    if (clr_select == "orange")
    {
        printf("\033[1m\033[38;5;208m%s\033[0m",clr);  // Code ANSI de l'orange
    }
    if (clr_select == "red")
    {
        printf("\033[1m\033[31m%s\033[0m",clr);  // Code ANSI du rouge
    }
    if (clr_select == "blue")
    {
        printf("\033[1m\033[34m%s\033[0m",clr);  // Code ANSI du bleu
    }
    if (clr_select == "green")
    {
        printf("\033[1m\033[32m%s\033[0m",clr);  // Code ANSI du vert
    }
    if (clr_select == "yellow")
    {
        printf("\033[1m\033[33m%s\033[0m",clr);  // Code ANSI du jaune
    }
    if (clr_select == "magenta")
    {
        printf("\033[1m\033[35m%s\033[0m",clr);  // Code ANSI du magenta
    }
    if (clr_select == "cyan")
    {
        printf("\033[1m\033[36m%s\033[0m",clr);  // Code ANSI du cyan
    }
}
...
// FONCTION SERVANT A METTRE EN GRAS LES ENTIERS ET LES FLOATS

void bold2(float var, char clr_select[])
{
    if (clr_select == "white")
    {
        printf("\033[1m%g\033[0m",var);  // Couleur par défaut
    }
    if (clr_select == "orange")
    {
        printf("\033[1m\033[38;5;208m%g\033[0m",var);  // Code ANSI de l'orange
    }
    if (clr_select == "red")
    {
        printf("\033[1m\033[31m%g\033[0m",var);  // Code ANSI du rouge
    }
    if (clr_select == "blue")
    {
        printf("\033[1m\033[34m%g\033[0m",var);  // Code ANSI du bleu
    }
    if (clr_select == "green")
    {
        printf("\033[1m\033[32m%g\033[0m",var);  // Code ANSI du vert
    }
    if (clr_select == "yellow")
    {
        printf("\033[1m\033[33m%g\033[0m",var);  // Code ANSI du jaune
    }
    if (clr_select == "magenta")
    {
        printf("\033[1m\033[35m%g\033[0m",var);  // Code ANSI du magenta
    }
    if (clr_select == "cyan")
    {
        printf("\033[1m\033[36m%g\033[0m",var);  // Code ANSI du cyan
    }
}
